...
2. **Confusion Metrix**
The confusion matrix was computed to evaluate the model's classification performance, providing measures such as accuracy, sensitivity, and specificity. This validation assesses the model's predictive capabilities and its performance in correctly classifying approval decisions.
